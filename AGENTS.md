...
- Run `./tests.main.kts` after Java changes. If Gradle configuration or Kotlin build logic changes, also run `./gradlew ktlintFormat` when available and finish with `./gradlew build`.
